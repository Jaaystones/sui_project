        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg max-w-md w-full">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex justify-between gap-4">
                        ...
                        <>
                            ...
                            disabled={votingDisable}
                                ...
                                py-2 rounded hover:bg-green-600 transition-colors disabled:bg-gray-300 disabled:cusor-not-allowed"
                            >
                                Vote Yes
                            </button>
                            <button
                    ...
                    <button
                      onClick={onClose} className="w-full border border-gray-300 dark:border-gray-600 px-4 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                      >
                        Cancel
